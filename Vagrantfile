...
Vagrant.configure("2") do |config|
  ...
  config.vm.provider :aws do |aws, override|
    ...
    #
    #aws.access_key_id = "fkraayvanger"
    #aws.secret_access_key = "thisiskey"
    #aws.session_token = "thisistoken"
    ...
    override.ssh.private_key_path = "~/.ssh/cosc349-A2.pem"
    ...
    # square brackets.
    #
    aws.security_groups = ["sg-041429b7cae072626","sg-0a241f80a68b10e7d"]
